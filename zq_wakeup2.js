...
function signup(timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kd.youth.cn/WebApi/PunchCard/signUp?'+zq_cookie21,
            headers : {'Host': 'kd.youth.cn',
            'Content-Length': '0',
             'Referer':' https://kd.youth.cn/h5/20190603cardactive/?'+'keyword_wyq=woyaoq.com&access=4G&app-version=8.1.2&app_version=8.1.2&carrier=%E4%B8%AD%E5%9B%BD%E7%A7%BB%E5%8A%A8&channel=c1005&'+zq_cookie21
            },
        }
...
function wakeup(timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kd.youth.cn/WebApi/PunchCard/doCard?'+zq_cookie21,
            headers : {'Host': 'kd.youth.cn',
            'Content-Length': '0',
             'Referer':' https://kd.youth.cn/h5/20190603cardactive/?'+'keyword_wyq=woyaoq.com&access=4G&app-version=8.1.2&app_version=8.1.2&carrier=%E4%B8%AD%E5%9B%BD%E7%A7%BB%E5%8A%A8&channel=c1005&'+zq_cookie21
            },
