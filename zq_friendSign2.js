...
!(async () => {
    ...
    .finally(() => $.done())
//查询好友列表
function friendlist(zq_cookie21,timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kandian.wkandian.com/WebApi/ShareSignNew/getFriendFinalList?'+zq_cookie21,
            headers : {'Host': 'kandian.wkandian.com',
                'Referer':'https://kandian.wkandian.com/h5/20201020missionSign/?'+zq_cookie21
            },
        }
...
function friendSign(uid,timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kandian.wkandian.com/WebApi/ShareSignNew/sendScoreV2?friend_uid='+uid+'&'+zq_cookie21,
            headers : {'Host': 'kandian.wkandian.com',
                'Referer':'https://kandian.wkandian.com/h5/20201020missionSign/?'+zq_cookie21
            },
        }
